...
#---directly run on arcgis jupiter notebook
if False:
    #Using CURRENT PROJECT and REFRESHING LAYERS INSTANLY
...
if __name__=='__main__':
    ...
    styles= InspectStyleitem(project,R'C:\Users\Documents\geologia-territorial-250000-geologic.stylx' )
    for st in styles: 
        print(st.name)

...
wkspace= R'C:\Users\Documents\espais-interes-geologic-v2r0-20230621'
                ...
                for row in cursor:
                    ...
                    if row[1]!=' ':
                        if not row[1] in values:
                            ...
                            result.loc[row[0],fields[1]]=row[1]

        print('Final Dataframe:\n',result)
        ExcelExport(result,R'C:\Documents\llistElem.xlsx',hoja='elements')
